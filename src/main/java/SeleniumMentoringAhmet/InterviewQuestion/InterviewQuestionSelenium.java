...
public class InterviewQuestionSelenium {

    public class InterviewQuestions {
    /*
    1)What are the advantages and disadvantages of Selenium
    Advantages:Free open sources
               *It supports multiple languages(java,javaScript,ruby,python, C sharp)
               *Big community
               *It supports multiBrowsers(chrome, safari, internet Explorer,firefox)
    Disadvantages: *captcha,pictures,finger prints etc.. cannot be automated by Selenium
    ...
    * I went with different ATTRIBUTE to locate the elements**********
    ...
    - Absolute XPATH:Syntax is different
        -Relative XPATH:it goes directly to the element location.
         -Relative XPATH:it has // (double slash) before XPATH structure
         -Relative XPATH:Syntax is different
      ...
      *NoSuchFrame Exception
      ...
      13) In what condition do you get StaleElementReference Exception? How do you handle ?
      ...
      *JavaScript(Browser) Alert : Alert Class
       ...
       *getText()-->get the text
        ...
        16) What do you know about iframe(Frame)? Can you tell me the type that you used before? and
         ...
         from products. All xpath is correct and there is problem with attribute as well. But i cannot get it.
         What do you think the reasons could be?

         ** The reason could be the iFrame, so I basically go to the website and in the dom i just search for the iframe.
         Maybe website doesn't work properly.

         *iframe is the html inside of the another html>?
         * driver.switchTo().frame(1)
         ***** driver.switchTo().defaultContent() **************
         * driver.switchTo() frame(2)
         *** if you have multiple iframes into the each other. Then I should use driver.switchTo()ParentFrame().


         17) What do you know about ACTIONS CLASS?

         * Actions class is really useful to handle some issues in my project since i use some actions class methods.
        ...
        * Once the elements is not found ** it doesnt throw any exception but it returns EMPTY LIST
        ...
        * Selected and checkbox mentality is similar but the difference is you can only choose one radio button option
        ...
        *********
        ...
        for(String id : ids){ facebook page (id 12345 and twitter page (1234567), ebay
